...
output "cloudwatch_alarm_arn" {
  ...
  # arn:aws:cloudwatch:eu-west-3:470201305353:alarm:acm-certificate-expiry-tst-plt-echotwin-xyz
}
...
output "dashboard_url" {
  ...
  # https://console.aws.amazon.com/cloudwatch/home?region=eu-west-3#dashboards:name=acm-certificates-tst-plt-echotwin-xyz
}
